...
```{r figure_2_v_wide png}
png(
  filename = "plots/figure_2_v_wide.png",
  width = 20,
  height = 12.5,
  units = "cm",
  res = 300
...
```{r figure_2_b_wide png}
png(
  filename = "plots/figure_2_b_wide.png",
  width = 20,
  height = 12.5,
  units = "cm",
  res = 300
